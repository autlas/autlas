...
export const iconButtonVariants = tv({
    ...
    variants: {
        variant: {
            ...
            actionIndigo: "bg-white/5 text-[#71717a] border border-white/5 hover:bg-indigo-500/10 hover:text-indigo-400 hover:border-indigo-500/20",
            actionRed: "bg-white/5 text-[#71717a] border border-white/5 hover:bg-red-500/10 hover:text-red-500 hover:border-red-500/20",
            actionYellow: "bg-white/5 text-[#71717a] border border-white/5 hover:bg-yellow-500/10 hover:text-yellow-500 hover:border-yellow-500/20",
            actionGreen: "bg-white/5 text-[#71717a] border border-white/5 hover:bg-green-500/10 hover:text-green-500 hover:border-green-500/20",
        },
        size: {
